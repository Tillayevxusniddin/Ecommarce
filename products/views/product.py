...
from rest_framework import filters  # search uchun
...
class ProductViewSet(viewsets.ModelViewSet):
    ...
    def list(self, request, *args, **kwargs):
        category = request.query_params.get('category', None)  # query parametrda categoryga qarab listni get qilish imkoniyati
        if category:
